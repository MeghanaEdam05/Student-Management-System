...
class studentClass:
    def __init__(self,root):
        ...
        title.place(x=10,y=15,width=1080,height=35)
        #==variables====
        ...
        txt_state=Entry(self.root,textvariable=self.var_state,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=140,y=220,width=130)
        
        lbl_city=Label(self.root,text="City",font=("goudy old style",15,'bold'),bg='white').place(x=280,y=220)
        txt_city=Entry(self.root,textvariable=self.var_city,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=330,y=220,width=130)
        
        lbl_pin=Label(self.root,text="PIN",font=("goudy old style",15,'bold'),bg='white').place(x=480,y=220)
        txt_pin=Entry(self.root,textvariable=self.var_pin,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=540,y=220,width=130)
        ...
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=140,y=100,width=200)
        txt_email=Entry(self.root,textvariable=self.var_email,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=140,y=140,width=200)
        ...
        self.txt_gender.place(x=140,y=180,width=200)
        ...
        lbl_email=Label(self.root,text="Addmission",font=("goudy old style",15,'bold'),bg='white').place(x=360,y=140)
        ...
        #functioncall====
        self.fetch_course()
        txt_dob=Entry(self.root,textvariable=self.var_dob,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=470,y=60,width=200)
        ...
        self.txt_address.place(x=140,y=260,width=530,height=100)
        ...
        txt_search_roll=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=860,y=60,width=110)
        btn_search=Button(self.root,text="Search",font=("goudy old style",15,'bold'),bg="#03a9f4",fg="white",cursor="hand2",command=self.search)
        btn_search.place(x=975,y=60,width=120,height=28)
        #===contents=====
        self.C_Frame=Frame(self.root,bd=2,relief=RIDGE)
        self.C_Frame.place(x=720,y=100,width=370,height=340)
            ...
            if self.var_roll.get()=="":
                ...
                if row==None:
                    ...
                    if op==True:
                        ...
                        con.commit()
                        messagebox.showinfo("Delete","Studenr deleted successfully",parent=self.root)
                        self.clear()
        except Exception as ex:
            messagebox.showerror("Error",f"Error due to {str(ex)}")
