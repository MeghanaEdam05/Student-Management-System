...
class CourseClass:
    def __init__(self,root):
        ...
        txt_search_coursename=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=860,y=60,width=110)
        ...
        self.CourseTable.column("description",width=50)
        self.CourseTable.pack(fill=BOTH,expand=1)
